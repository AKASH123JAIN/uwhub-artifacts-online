...
//@Tag("integration")
//class UWHubUserControllerIntegrationTest {
//
//    @Autowired
//    MockMvc mockMvc;
//
...
//        // User Amith has all permissions.
//        ResultActions resultActions = this.mockMvc.perform(post(this.baseUrl + "/users/login").with(httpBasic("Amith", "123456"))); // httpBasic() is from spring-security-test.
...
//        hogwartsUser.setUsername("Amith123"); // Username is changed.
//        hogwartsUser.setEnabled(true);
...
//                .andExpect(jsonPath("$.data.username").value("Amith"));
//    }
//
//    @Test
...
//                .andExpect(jsonPath("$.data[0].username").value("Amith"));
//    }
//
//}