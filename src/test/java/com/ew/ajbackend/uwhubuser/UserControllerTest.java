...
class UserControllerTest {
    ...
    void testAddUserSuccess() throws Exception {
        ...
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.save(Mockito.any(UWHubUser.class))).willReturn(user);
    ...
    void testUpdateUserSuccess() throws Exception {
        ...
        UWHubUser updatedUser = new UWHubUser();
        updatedUser.setId(3);
        ...
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(3), Mockito.any(UWHubUser.class))).willReturn(updatedUser);
    ...
    void testUpdateUserErrorWithNonExistentId() throws Exception {
        // Given. Arrange inputs and targets. Define the behavior of Mock object userService.
        given(this.userService.update(eq(5), Mockito.any(UWHubUser.class))).willThrow(new ObjectNotFoundException("user", 5));
